...
![Barry Marples](./readme-docs/portfolio-barry-marples.png)
...
This required some reconfiruation of the layout using the bootstrap elements. 
...
- **Who What Why**: three sentences that allows users to know quickly get an overview of the developer.
Animated graphic showing the developer hard at work, this will disapear on smaller screens.
...
- **Work History**: a timeline of the positions held so the users can quickly understand the developer past career.

**Portfolio Page** includes:

- **Description of each project**: allows the users to quickly get understand the scope of the project.
- **Example layouts Graphic**: illustrates simply how the site has been built to work for all devices.
- **Live Project Link**: users can exploer the project futher in a seperate browers window.
- **How it was made**: details of technologies used for each project.

**Contact Page** includes:

- **Personal info**: allows users to post documents, phone and e-mail files to the developer if nessecary.
- **Contact form**: allows users to make initial contact in a sturctured format so that the developer can respond with an answer and not need to ask for more details.
...
2. This opens a view showing the url for the project click the copy icon to get the the full repository address.
3. Open Terminal and ensure to navigate to folder where you want to place the cloned project.
4. Type **git clone** and now paste the url you coppied earlier.
